...
export default function ComingSoon({ label = "Em breve", children, className = "" }: ComingSoonProps) {
  return (
    <div className={`relative ${className}`}>
      ...
      <div aria-disabled="true" className="pointer-events-none opacity-50 blur-[1px]">
        {children}
      </div>
